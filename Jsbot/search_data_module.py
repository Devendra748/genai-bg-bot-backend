...
def get_chat_response(question, chat_history, language, bot_name):
    new_summary_tmpl_str = (
        ...
        "Try to answer in bullet points and  First translate your full answer in {lang} language and give answer only in {lang} language\n"
        "If you do not get answer of the query from context then simply return 'undefined'\n"
         ...
         "Avoid any references to the Congress party, Rahul Gandhi, or individuals/entities not affiliated with the BJP.\n"
        "Query: {query_str}\n"
        "Answer: "
    )
